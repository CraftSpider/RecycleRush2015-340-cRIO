...
import edu.wpi.first.wpilibj.templates.commands.Auto4BarStillBinGrab;
import edu.wpi.first.wpilibj.templates.commands.AutoGetBins;
import edu.wpi.first.wpilibj.templates.commands.AutoMobility;
import edu.wpi.first.wpilibj.templates.commands.AutoMobilityLonger;
import edu.wpi.first.wpilibj.templates.commands.BinarySwitchesRunAuto;
