...
public class RobotMap {
    ...
    public static int DriveRightA = 1;
    public static int DriveLeftA = 2;
...
//    public static int FourBarEncoderLeft2 = 9;*/
    public static int FourBarEncoderRight1 = 1;
    public static int FourBarEncoderRight2 = 2;
    
    public static int FourBarBottomLeftA = 9;
    public static int FourBarBottomLeftB = 10;
    public static int FourBarBottomRightA = 7;
    public static int FourBarBottomRightB = 8;
    
    public static int FourBarTopLimit = 6;
